  ...
  return (
    <>
      <div className="container">
        ...
        <p>Welcome to saisatishgroups.com (“Company”, “we”, “our”, “us”)!</p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at saisatishgroups.com (together or
          individually “Service”) operated by saisatishgroups.com.
        </p>
        <p>
        ...
        <p>
          ...
          <b>saisatishmulti@gmail.com</b> so we can try to find a solution.
        ...
        <p>
          saisatishgroups.com has the right but not the obligation to monitor
          and edit all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of saisatishgroups.com or used with permission. You may not
        ...
        <p>
          ...
          property of Sai Groups and its licensors. Service is protected by
          ...
          without the prior written consent of Sai Groups.
        </p>
        <p>
        ...
        <p>
          ...
          to saisatishmulti@gmail.com, with the subject line: “Copyright
        ...
        <p>
          You may provide us either directly at saisatishmulti@gmail.com or via
        ...
        <p>
          ...
          that are not owned or controlled by saisatishgroups.com.
        </p>
        <p>
          saisatishgroups.com has no control over, and assumes no responsibility
        ...
        <p>
          ...
          laws of Indai, which governing law applies to agreement without regard
        ...
        <p>
          ...
          email: saisatishgroups@gmail.com.
        </p>
      </div>
    </>
  );
