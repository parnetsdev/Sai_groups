  ...
  return (
    <>
      <div className="container">
        ...
        <p>
          The information provided by <b>Sai Groups</b> (“Company”, “we”, “our”,
          “us”) on <b>www.saisatishgroups.com</b> (the “Site”) is for general
        ...
        <p>
          ...
          contained in this site has been obtained from reliable sources, Sai
          Group is not responsible for any errors or omissions or for the
        ...
        <p>
          In no event will Sai Groups, its related partnerships or corporations,
        ...
        <p>
          ...
          www.saisatishgroups.com are the trademarks and logos of their
          respective owners. Any inclusion of such trademarks or logos does not
          imply or constitute any approval, endorsement or sponsorship of Sai
          Group by such owners.
        </p>
        {/* <p>
          <b>CONTACT US</b>
        </p>
        <p>
          ...
          <b>saisatishmulti@gmail.com</b>.
        </p>
        <p style="margin-top: 5em; font-size: 0.7em;">
          This <a href="#">Disclaimer</a> was
          created for <b>www.saisatishgroups.com</b> by{" "}
          <a href="https://policymaker.io">PolicyMaker.io</a> on 2023-11-30.
        </p> */}
      </div>
    </>
  );
