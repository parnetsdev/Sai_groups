    ...
    try {
      ...
      let config = {
        ...
        data: {
          ...
          centername: centerexecutivename,
          centerphone: centerexecutivephone,
          centeremail: centerexecutiveemail,
          centerbankname: centerexecutivebankname,
          centeraccountnumber: centerexecutiveaccountnumber,
          centerifscCode: centerexecutiveifscCode,
          centerbranchname: centerexecutivebranchname,
          centercommissionamount: centerexecutivecommissionamount,
        },
      };
